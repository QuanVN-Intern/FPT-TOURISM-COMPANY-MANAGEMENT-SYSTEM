...
('staff1',       @pwd, 'Alice Staff',   'staff1@travel.com',       3, 1, 0),

-- Test accounts (one per role)
('manager_test', @pwd, 'Mary Manager',  'manager_test@travel.com', 2, 1, 0),
('staff_test',   @pwd, 'Steve Staff',   'staff_test@travel.com',   3, 1, 0),
('driver_test',  @pwd, 'Dave Driver',   'driver_test@travel.com',  4, 1, 0),
('recept_test',  @pwd, 'Rachel Recept', 'recept_test@travel.com',  5, 1, 0);
...
('TOUR001', N'Tour Đà Nẵng 3N2Đ',          1, 3, 3500000, 20, 20, '2026-04-01', N'Tour nghỉ dưỡng biển Đà Nẵng', 'https://example.com/danang.jpg'),
('TOUR002', 'Phu Quoc Island Tour 4D3N',    3, 4, 5500000, 25, 25, '2026-04-05', 'Island exploration',            NULL),
('TOUR003', 'Sapa Mountain Tour 2D1N',      4, 2, 2500000, 15, 15, '2026-04-10', 'Trekking and nature',           NULL),
('TOUR004', 'Bangkok City Tour 5D4N',       5, 5, 8500000, 30, 30, '2026-04-15', 'City and culture',              NULL),
('TOUR005', 'Singapore Premium Tour 3D2N',  6, 3, 9000000, 18, 18, '2026-04-20', 'Luxury travel experience',      NULL);
